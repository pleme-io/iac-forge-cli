    ...
    crates = {
      ...
      "ansible-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "24a3ed6972b4bc14ea7bec3afd47eecbcfda05ae";
          sha256 = "0pfpjs059h957kr7j1frlpyx8bi3kxpikcp1qr4f211fy6x064z9";
        };
      ...
      "crossplane-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "96a6a2c1f13875e4a4be3ce6c312962048b08449";
          sha256 = "19002d4r9nj870sqj204gy0bsf8m28awy15gzx7lq3fxaxssv6np";
        };
      ...
      "helm-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8c9f33eb5832d320bf52cf42857c01c7c61e8293";
          sha256 = "1pkg757hna37l1ivr9ccwfjl9qn6hdmcdxl4insmpyva3n9gr2ak";
        };
        libName = "helm_forge";
        dependencies = [
          {
      ...
      "openapi-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "9effae90178365cfb60faa804a73c4d31ddb3143";
          sha256 = "14bvzmd55zn2scsjk3k5653227ck00h35xy7fl0yprdj6npsjpa8";
        };
      ...
      "pulumi-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "b7f54f2797294c040a3e4d1d931b2e0fe6049dd8";
          sha256 = "02imi3f67xq0vyn11j16pan1dc9bfhc824y6mrfk4q00f2ppacmv";
        };
      ...
      "steampipe-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "ede6605961ca1f0ff3dcd3a84ea24564780e867e";
          sha256 = "1dn1pdll9p87vzhd190vscly88xivdmfx5qphr00kdrk0wsjm21p";
        };
      ...
      "terraform-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "cabce361f0823b61dbc5cd3f143a5f1c1b13d891";
          sha256 = "007rakjxcscd1afwjm3hcz0bmb5nwm4vf57r7j1iwszi0dh4gqkv";
        };
